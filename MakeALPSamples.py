...
sim.generators.append(generators.lhe( "Signal Generator", ("/Users/user/ldmx-sw/ALPSamples/photon_fusion_events/m_200_decayed_1/unweighted_events.lhe" )))
...
p.sequence=[ sim, hcalDigis, ecalDigis, hcalrec, ecalrec]

p.outputFiles = [ "ALP_m200.root"]

p.maxEvents = 100000
p.logFrequency = 10
p.lheFilePath = ("/Users/user/ldmx-sw/ALPSamples/photon_fusion_events/m_200_decayed_1/unweighted_events.lhe" )
p.pause()
