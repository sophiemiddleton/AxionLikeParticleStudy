...
ROOT.gSystem.Load("/nfs/slac/g/ldmx/users/smidd/NewLDMX/v2.3/NewChristina/ldmx-sw/install/lib/libHcal_Event.so")	;
ROOT.gSystem.Load("/nfs/slac/g/ldmx/users/smidd/NewLDMX/v2.3/NewChristina/ldmx-sw/install/lib/libEcal_Event.so")	;
ROOT.gSystem.Load("/nfs/slac/g/ldmx/users/smidd/NewLDMX/v2.3/NewChristina/ldmx-sw/install/lib/libRecon_Event.so")	;
ROOT.gSystem.Load("/nfs/slac/g/ldmx/users/smidd/NewLDMX/v2.3/NewChristina/ldmx-sw/install/lib/libSimCore_Event.so")	;
import os
import math
import sys
...
class WabSigCompare:
    ...
    def loop(self):
        ...
        for i in range(nentWAB):
            ...
            HCAL_elec = []
            HCAL_phot = []
            print("LEGNTH",len(self.simParticles1))
            ...
            if energy_sum_HCAL_SP_electron !=0 :
            ...
            if energy_sum_target_SP_electron !=0:
            ...
            if energy_sum_HCAL_SP_photon !=0:
            ...
            if energy_sum_target_SP_photon !=0:
